...
const CategoryDetails = ({ category }) => {
    ...
    <div className='max-w-[1100px] m-auto flex flex-col justify-between gap-3 py-3 px-5'>
        <div className='py-5'>
            ...
            <h3 className='text-7xl font-bold text-basic-green before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-pink-600 relative inline-block'> <span className="relative text-white">{category.name}</span></h3>
        </div>
